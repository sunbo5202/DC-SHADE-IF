...
for func = 1:28
    t1=cputime;
    %% Update parameter of the framework
    ...
    for run_id = 1 : 1
        ...
        %% =============================
        %% Parameter of phase
        phase=1;switch_rate=0.3;
        %% =================
        %% Parameter of SAepsilon
        N=pop_size;
        ...
        SRF03(func,run_id)=bsf_fit_var;
        SRC03(func,run_id)=bsf_cov_var;
...
%save('ParametersSR0_3.mat','SRF03','SRC03')